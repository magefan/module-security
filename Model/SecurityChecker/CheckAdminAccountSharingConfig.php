...
class CheckAdminAccountSharingConfig extends AbstractChecker
{
    /**
    ...
    public function issueExists()
    {
        if (null === $this->issueExists || $this->issueExists === SecurityCheckerInterface::CANT_CHECK) {
            $this->issueExists = $this->scopeConfig->getValue(self::XML_PATH_ADMIN_ACCOUNT_SHARING) ?
    ...
    {
        return (string)__('Admin account sharing enabled');
    }
