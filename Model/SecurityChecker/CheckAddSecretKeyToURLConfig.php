...
class CheckAddSecretKeyToURLConfig extends AbstractChecker
{
    /**
    ...
    public function issueExists()
    {
        if (null === $this->issueExists || $this->issueExists === SecurityCheckerInterface::CANT_CHECK) {
            $this->issueExists = !$this->scopeConfig->getValue(self::XML_PATH_USE_SECURE_KEY)
    ...
    {
        return (string)__('Missing secret key in admin URLs');
    }
